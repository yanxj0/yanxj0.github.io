...
// packages/engine/node_modules/.pnpm/draco3d@1.5.1/node_modules/draco3d/draco_decoder_nodejs.js
var require_draco_decoder_nodejs = __commonJS({
  "packages/engine/node_modules/.pnpm/draco3d@1.5.1/node_modules/draco3d/draco_decoder_nodejs.js"(exports, module) {
    var $jscomp = $jscomp || {};
    $jscomp.scope = {};
    ...
    $jscomp.polyfill("Promise", function(k) {
      ...
      h.all = function(f) {
        ...
        return v.done ? l([]) : new h(function(z, F) {
          ...
          var Q = [], u = 0;
          do
            Q.push(void 0), u++, l(v.value).callWhenSettled_(da(Q.length - 1), F), v = q.next();
          while (!v.done);
        });
      };
      return h;
    ...
    var DracoDecoderModule = function() {
      ...
      return function(n) {
        ...
        function p(e, b, c) {
          ...
          for (c = b; e[c] && !(c >= d); )
            ++c;
          if (16 < c - b && e.subarray && xa)
            return xa.decode(e.subarray(b, c));
          for (d = ""; b < c; ) {
            var g = e[b++];
            if (g & 128) {
              var t = e[b++] & 63;
              if (192 == (g & 224))
                ...
                var W = e[b++] & 63;
                g = 224 == (g & 240) ? (g & 15) << 12 | t << 6 | W : (g & 7) << 18 | t << 12 | W << 6 | e[b++] & 63;
        ...
        function v() {
          if (!fa && (Aa || ha)) {
            if ("function" === typeof fetch && !R.startsWith("file://"))
              return fetch(R, { credentials: "same-origin" }).then(function(e) {
                if (!e.ok)
        ...
        function Q(e) {
          function b() {
            if (!la && (la = true, a.calledRun = true, !za)) {
              Ca = true;
              z(ra);
              Da(a);
        ...
        n = n || {};
        var a = "undefined" !== typeof n ? n : {}, Ya = Object.assign, Da, oa;
        a.ready = new Promise(function(e, b) {
          Da = e;
          oa = b;
        });
        var Za = false, $a = false;
        ...
        a.onModuleParsed = function() {
          $a = true;
          if (Za && "function" === typeof a.onModuleLoaded)
            a.onModuleLoaded(a);
        };
        ...
        var ab = Ya(
          {},
          a
        ), Aa = "object" === typeof window, ha = "function" === typeof importScripts, V = "", ta, ma;
        if ("object" === typeof process && "object" === typeof process.versions && "string" === typeof process.versions.node) {
          V = ha ? __require("path").dirname(V) + "/" : __dirname + "/";
          var bb = function() {
            ma || (ta = __require("fs"), ma = __require("path"));
          };
          var cb = function(e, b) {
            bb();
            e = ma.normalize(e);
          ...
          ha ? V = self.location.href : "undefined" !== typeof document && document.currentScript && (V = document.currentScript.src), k && (V = k), V = 0 !== V.indexOf("blob:") ? V.substr(0, V.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", cb = function(e) {
        ...
        var xd = a.print || console.log.bind(console), ca = a.printErr || console.warn.bind(console);
        Ya(a, ab);
        ab = null;
        var fa;
        a.wasmBinary && (fa = a.wasmBinary);
        "object" !== typeof WebAssembly && f("no native wasm support detected");
        var na, za = false, xa = "undefined" !== typeof TextDecoder ? new TextDecoder("utf8") : void 0, ya, Y, ea, G, Ba, Fa = [], ra = [], Ea = [], Ca = false, ba = 0, ua = null, ia = null;
        a.preloadedImages = {};
        a.preloadedAudios = {};
        ...
        var ka = [], yd = 0, ja = {
          ...
          printChar: function(e, b) {
            var c = ja.buffers[e];
            0 === b || 10 === b ? ((1 === e ? xd : ca)(p(c, 0)), c.length = 0) : c.push(b);
          },
          varargs: void 0,
          get: function() {
            ja.varargs += 4;
          ...
          b: function(e, b, c, d) {
            for (var g = 0, t = 0; t < c; t++) {
              var W = G[b >> 2], va = G[b + 4 >> 2];
              b += 8;
              for (var wa = 0; wa < va; wa++)
                ja.printChar(e, ea[W + wa]);
              g += va;
            }
            G[d >> 2] = g;
            return 0;
        ...
        (function() {
          function e(g, t) {
            ...
            0 == ba && (null !== ua && (clearInterval(ua), ua = null), ia && (g = ia, ia = null, g()));
          }
          function b(g) {
            e(g.instance);
          }
          ...
          if (a.instantiateWasm)
            try {
              ...
              return ca("Module.instantiateWasm callback failed with error: " + g), false;
            }
          (function() {
            return fa || "function" !== typeof WebAssembly.instantiateStreaming || R.startsWith("data:application/octet-stream;base64,") || R.startsWith("file://") || "function" !== typeof fetch ? c(b) : fetch(R, { credentials: "same-origin" }).then(function(g) {
        ...
        var eb = a._emscripten_bind_VoidPtr___destroy___0 = function() {
          ...
          return (Ga = a._emscripten_bind_DecoderBuffer_DecoderBuffer_0 = a.asm.m).apply(null, arguments);
        ...
        }, Ha = a._emscripten_bind_AttributeTransformData_AttributeTransformData_0 = function() {
          return (Ha = a._emscripten_bind_AttributeTransformData_AttributeTransformData_0 = a.asm.p).apply(null, arguments);
        ...
        }, Ia = a._emscripten_bind_GeometryAttribute_GeometryAttribute_0 = function() {
          return (Ia = a._emscripten_bind_GeometryAttribute_GeometryAttribute_0 = a.asm.s).apply(null, arguments);
          ...
          return (Ja = a._emscripten_bind_PointAttribute_PointAttribute_0 = a.asm.u).apply(null, arguments);
        ...
        }, Ka = a._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 = function() {
          return (Ka = a._emscripten_bind_AttributeQuantizationTransform_AttributeQuantizationTransform_0 = a.asm.F).apply(null, arguments);
        ...
        }, La = a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 = function() {
          return (La = a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 = a.asm.L).apply(null, arguments);
          ...
          return (Ma = a._emscripten_bind_PointCloud_PointCloud_0 = a.asm.P).apply(null, arguments);
          ...
          return (Db = a._emscripten_bind_PointCloud_num_points_0 = a.asm.R).apply(
            null,
            arguments
          );
          ...
          return (Na = a._emscripten_bind_Mesh_Mesh_0 = a.asm.T).apply(null, arguments);
          ...
          return (Oa = a._emscripten_bind_Metadata_Metadata_0 = a.asm.Y).apply(null, arguments);
        ...
        }, Pa = a._emscripten_bind_DracoFloat32Array_DracoFloat32Array_0 = function() {
          return (Pa = a._emscripten_bind_DracoFloat32Array_DracoFloat32Array_0 = a.asm.ca).apply(null, arguments);
          ...
          return (Qa = a._emscripten_bind_DracoInt8Array_DracoInt8Array_0 = a.asm.ga).apply(null, arguments);
          ...
          return (Ra = a._emscripten_bind_DracoUInt8Array_DracoUInt8Array_0 = a.asm.ka).apply(null, arguments);
          ...
          return (Sa = a._emscripten_bind_DracoInt16Array_DracoInt16Array_0 = a.asm.oa).apply(null, arguments);
        ...
        }, Ta = a._emscripten_bind_DracoUInt16Array_DracoUInt16Array_0 = function() {
          return (Ta = a._emscripten_bind_DracoUInt16Array_DracoUInt16Array_0 = a.asm.sa).apply(null, arguments);
          ...
          return (Ua = a._emscripten_bind_DracoInt32Array_DracoInt32Array_0 = a.asm.wa).apply(null, arguments);
        ...
        }, Va = a._emscripten_bind_DracoUInt32Array_DracoUInt32Array_0 = function() {
          return (Va = a._emscripten_bind_DracoUInt32Array_DracoUInt32Array_0 = a.asm.Aa).apply(null, arguments);
          ...
          return (Wa = a._emscripten_bind_MetadataQuerier_MetadataQuerier_0 = a.asm.Ea).apply(null, arguments);
          ...
          return (mc = a._emscripten_bind_MetadataQuerier_GetStringEntry_2 = a.asm.Ja).apply(
            null,
            arguments
          );
          ...
          return (Xa = a._emscripten_bind_Decoder_Decoder_0 = a.asm.Na).apply(null, arguments);
          ...
          return (db = a._malloc = a.asm.Ub).apply(
            null,
            arguments
          );
        };
